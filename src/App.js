...
const featuresData = {
  tr: [
    { icon: 'zap',      title: 'Macho Executor Uyumlu',    desc: 'narcolepsy.lua tamamen Macho Executor ile test edilmiş ve optimize edilmiştir. Inject sonrası anında aktif olur.' },
  ...
  en: [
    { icon: 'zap',      title: 'Macho Executor Compatible', desc: 'narcolepsy.lua has been fully tested and optimized for Macho Executor. Activates instantly after inject.' },
